...
static const gui_theme_def_t gui_themes[GUI_THEME_COUNT] = {
    ...
    /* ------------------------------------------------------------------ */
    {
        ...
        .screen_bg                  = 0x7386A5,
        .screen_grad                = 0xF6F8FE,
        .sidebar_bg                 = 0xF6F8FE,
        .sidebar_grad               = 0x7386A5,
        .sidebar_shadow             = 0xA5B2C5,
        .brand_text                 = 0x364759,
        .content_bg                 = 0xF6F8FE,
        .content_grad               = 0x7386A5,
        .content_shadow             = 0xA5B2C5,
        .title_text                 = 0x6984B0,
        .subtitle_text              = 0x395784,
        .muted_text                 = 0x223A62,
        .value_text                 = 0x556A9B,
        .panel_bg                   = 0xF6F8FE,
        .panel_grad                 = 0x7386A5,
        .panel_border               = 0xA6B5C9,
        .card_bg                    = 0xF6F8FE,
        .card_grad                  = 0x7386A5,
        .card_border                = 0x9BABBF,
        .item_bg                    = 0xF6F8FE,
        .item_grad                  = 0x7386A5,
        .item_border                = 0xA6B5C9,
        .accent_color               = 0x3E60BB,
        .accent_grad                = 0x2A4693,
        .accent_soft_color          = 0x26428C,
        .keyboard_bg                = 0xF6F8FE,
        .keyboard_bg_grad           = 0x7386A5,
        .keyboard_border            = 0xD7E1EE,
        .keyboard_key_bg            = 0xF6F8FE,
        .keyboard_key_grad          = 0x7386A5,
        .keyboard_key_text          = 0x10213D,
        .keyboard_special_bg        = 0x1D4ED8,
        .keyboard_special_grad      = 0x3A65DD,
        .keyboard_special_text      = 0xFFFFFF,
        .keyboard_special_border    = 0x1D4ED8,
        .slider_bg                  = 0xD9E3F1,
        .slider_grad                = 0xDDE6F2,
        .slider_knob_bg             = 0xFFFFFF,
        .slider_knob_grad           = 0xF8FBFF,
        .dropdown_bg                = 0xF6F8FE,
        .dropdown_grad              = 0x7386A5,
        .dropdown_border            = 0xD7E1EE,
        .dropdown_selected_bg       = 0x1D4ED8,
        .dropdown_selected_grad     = 0x3A65DD,
        .dropdown_selected_text     = 0xFFFFFF,
        .energy_chart_bg            = 0xF6F8FE,
        .energy_chart_grad          = 0x7386A5,
