...
static const gui_theme_def_t gui_themes[GUI_THEME_COUNT] = {
    ...
    /* ------------------------------------------------------------------ */
    {
        ...
        .sidebar_bg                 = 0xD7DEEA,
        .sidebar_grad               = 0xAFBED5,
        .sidebar_shadow             = 0x94A3B8,
        .brand_text                 = 0x1E3A57,
        .content_bg                 = 0xFFFFFF,
        .content_shadow             = 0xB8C7DB,
        .title_text                 = 0x314B77,
        .subtitle_text              = 0x334B70,
        .muted_text                 = 0x384C71,
        .value_text                 = 0x14203E,
        .panel_bg                   = 0xEEF1F7,
        .panel_border               = 0xCED7E8,
        .card_bg                    = 0xFFFFFF,
        .card_border                = 0xCED7E8,
        .item_bg                    = 0xEEF1F7,
        .item_border                = 0xCED7E8,
        .accent_color               = 0x56658F,
        .accent_soft_color          = 0x5C6C99,
        ...
        .wifi_connected_color       = 0x0040FF,
        .wifi_idle_color            = 0x73829C,
        .nav_active_bg              = 0xE8F0FF,
        .nav_active_text            = 0x10213D,
        .nav_active_border          = 0xA3C0FF,
        .nav_inactive_bg            = 0x4F5F82,
