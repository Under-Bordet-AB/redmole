...
static const gui_theme_def_t gui_themes[GUI_THEME_COUNT] = {
    ...
    /* ------------------------------------------------------------------ */
    {
        ...
        .sidebar_bg          = 0x111827,
        .sidebar_grad        = 0x111827,
        .sidebar_shadow      = 0x111827,
        .brand_text          = 0xE2E8F0,
        .content_bg          = 0x1E293B,
        .content_shadow      = 0x111827,
        .title_text          = 0xE2E8F0,
        .subtitle_text       = 0x94A3B8,
        .muted_text          = 0x818F9B,
        .value_text          = 0xE2E8F0,
        .panel_bg            = 0x243244,
        .panel_border        = 0x374151,
        .card_bg             = 0x172033,
        .card_border         = 0x374151,
        .item_bg             = 0x1F2937,
        .item_border         = 0x374151,
        .accent_color        = 0x60A5FA,
        .accent_soft_color   = 0x93C5FD,
        .keyboard_bg         = 0x2A3244,
        .keyboard_border     = 0x374151,
        .keyboard_key_bg     = 0x374151,
        .keyboard_key_text   = 0xE2E8F0,
        .keyboard_special_bg     = 0x2563EB,
        .keyboard_special_text   = 0xE2E8F0,
        .keyboard_special_border = 0x60A5FA,
        .slider_bg           = 0x374151,
        .slider_knob_bg      = 0xE2E8F0,
        .dropdown_bg         = 0x1F2937,
        .dropdown_border     = 0x475569,
        .dropdown_selected_bg   = 0x2563EB,
        .dropdown_selected_text = 0xE2E8F0,
        .energy_chart_bg     = 0x172033,
        .energy_chart_grid   = 0x374151,
        .energy_chart_tick   = 0x94A3B8,
        ...
        .wifi_idle_color      = 0x818F9B,
        .nav_active_bg       = 0x1D4ED8,
        .nav_active_text     = 0xE2E8F0,
        .nav_active_border   = 0x60A5FA,
        .nav_inactive_bg     = 0x172033,
        .nav_inactive_text   = 0x94A3B8,
        .nav_inactive_border = 0x374151,
        .action_primary_bg     = 0x2563EB,
        .action_primary_text   = 0xE2E8F0,
        .action_primary_border = 0x60A5FA,
        .action_secondary_bg     = 0x1F2937,
        .action_secondary_text   = 0xE2E8F0,
        .action_secondary_border = 0x475569,
        .wifi_btn_bg             = 0x1F2937,
        .wifi_btn_border         = 0x374151,
        .wifi_btn_text           = 0xE2E8F0,
        .wifi_btn_connected_bg   = 0x1A3528,
        .wifi_btn_connected_border = 0x4ADE80,
        .wifi_btn_connected_text   = 0xBBF7D0,
        .wifi_btn_known_bg       = 0x1A2D22,
        .wifi_btn_known_border   = 0x86EFAC,
        .wifi_btn_known_text     = 0xD1FAE5,
        .wifi_btn_selected_bg     = 0x1F2937,
