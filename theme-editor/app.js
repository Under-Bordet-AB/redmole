...
const colorGroups = [
    ...
    {
        title: "Content",
        fields: ["content_bg", "content_grad", "content_shadow"],
    },
    {
        title: "Typography",
    ...
    {
        title: "Accents",
        fields: ["accent_color", "accent_grad", "accent_soft_color"],
    },
    {
        title: "Keyboard",
        fields: [
